...
export const Route = createFileRoute("/_app/gmail_/overview")({
  ...
  component: () => (
    <IntegrationManagePage
      config={{
        ...
        Icon: Mail,
        accent: "text-red-500",
        headerTitle: "Gmail Intelligence Dashboard",
        headerSubtitle: "Monitor email volume, sync health, and recent activity for your Gmail workspace.",
        ...
        metrics: [
          { Icon: Inbox, label: "Emails Processed", value: 201, sub: "Total synced", delta: "12%", color: "text-primary bg-primary/10" },
          { Icon: Zap, label: "New Emails Today", value: 12, sub: "Since last sync", delta: "8%", color: "text-emerald-500 bg-emerald-500/10" },
          { Icon: Mail, label: "Important Emails", value: 7, sub: "AI-flagged", color: "text-amber-500 bg-amber-500/10" },
          { Icon: AlertTriangle, label: "Follow-Ups Needed", value: 4, sub: "Awaiting reply", color: "text-sky-500 bg-sky-500/10" },
        ],
        activity: [
        ...
        quickActions: [
          { Icon: Inbox, label: "Open Smart Inbox", color: "text-primary bg-primary/10", to: "/gmail/inbox" },
          { Icon: RefreshCw, label: "Run Manual Sync", color: "text-emerald-500 bg-emerald-500/10" },
